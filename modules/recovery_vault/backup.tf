...
resource "azurerm_backup_protected_vm" "backup" {
  ...
  resource_group_name   = try(var.settings.recovery_vaults.vault_key.resource_group_name, null)
  # recovery_vault_name = try(var.settings.backup.recovery_vault_name, null)
